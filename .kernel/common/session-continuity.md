...
# Load this file when aidlc-docs/aidlc-state.md already exists.

## RESUME PROTOCOL
1. Read aidlc-docs/aidlc-state.md fully before saying anything.
...
When resuming Construction phase, always re-read:
  - aidlc-docs/inception/frs.md          (requirements context)
  - aidlc-docs/construction/hld.md       (architecture context)
  - aidlc-docs/construction/lld.md       (if exists)
...
Bolts are tracked in aidlc-docs/aidlc-state.md under:
  ## Bolts:
